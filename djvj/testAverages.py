...
#Test 1 test if it will find the mode after 10 numbers are placed in the pitchArr
print ("test 1")
...
for x in range (0, 8):
    pitch1.pitchArr.append(testValues3[x])
    print (pitch1.lastAvg)
currAvg = pitchAverager(pitch1)
print (pitch1.lastAvg)
print (currAvg)
...
for x in range (0, 8):
    pitch1.pitchArr.append(testValues4[x])
    currAvg = pitchAverager(pitch1)
    print (pitch1.lastAvg)
currAvg = pitchAverager(pitch1)
print (pitch1.lastAvg)
